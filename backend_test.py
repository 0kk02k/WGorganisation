...
def main():
    ...
    tests = [
        ...
        tester.test_update_settings_rooms,
        tester.test_update_settings_checkin_template,
        tester.test_update_settings_checkout_template,
        tester.test_verify_settings_persistence,
